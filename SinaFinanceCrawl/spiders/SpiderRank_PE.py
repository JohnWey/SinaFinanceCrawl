...
path_profit = conf.get('Stock', 'path_outputfile').replace('?filename','Rank_PE')
...
class SpiderRank(Spider):
    ...
    #print start_urls
    start_urls = ["http://www.caiku.com/ranking/11/1/1/1.html",
                  "http://www.caiku.com/ranking/11/5/1/1.html",
                  "http://www.caiku.com/ranking/11/6/1/1.html",
                  "http://www.caiku.com/ranking/11/7/1/1.html"
                  ]
    v_itemSet = []
