...
path_profit = conf.get('Stock', 'path_outputfile').replace('?filename','Rank_EPS')
...
class SpiderRank(Spider):
    ...
    #print start_urls
    start_urls = ["http://www.caiku.com/ranking/13/1/1/1.html",
                  "http://www.caiku.com/ranking/13/5/1/1.html",
                  "http://www.caiku.com/ranking/13/6/1/1.html",
                  "http://www.caiku.com/ranking/13/7/1/1.html"
                  ]
    v_itemSet = []
    ...
    def parse(self,response):
        ...
        for v_rowid in range(2,v_linecnt_int+2):
            ...
            print 'eps,'+v_onerow.replace('---',0.0)
